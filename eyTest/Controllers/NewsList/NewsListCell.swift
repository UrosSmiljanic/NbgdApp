...
class NewsListCell: BaseCollectionViewCell {
    ...
    override func setupViews() {
        ...
        blackSeparator.anchor(top: title.bottomAnchor, leading: thumbail.trailingAnchor, bottom: nil, trailling: contentView.trailingAnchor, padding: .init(top: 0, left: 4, bottom: 0, right: 4) ,size: .init(width: 0, height: 1))
        
        addSubview(calThumbail)
        calThumbail.anchor(top: blackSeparator.bottomAnchor, leading: thumbail.trailingAnchor, bottom: nil, trailling: nil, padding: .init(top: 8, left: 4, bottom: 0, right: 0), size: .init(width: 22, height: 22))
        
        addSubview(publishDate)
        publishDate.anchor(top: blackSeparator.bottomAnchor, leading: calThumbail.trailingAnchor, bottom: contentView.bottomAnchor, trailling: nil, padding: .init(top: 8, left: 4, bottom: 12, right: 0), size: .init(width: 0, height: 22))
        
        addSubview(timeThumbail)
        timeThumbail.anchor(top: blackSeparator.bottomAnchor, leading: publishDate.trailingAnchor, bottom: nil, trailling: nil, padding: .init(top: 8, left: 8, bottom: 0, right: 0), size: .init(width: 22, height: 22))
        
        addSubview(publishTime)
        publishTime.anchor(top: blackSeparator.bottomAnchor, leading: timeThumbail.trailingAnchor, bottom: contentView.bottomAnchor, trailling: nil, padding: .init(top: 8, left: 4, bottom: 12, right: 0))
